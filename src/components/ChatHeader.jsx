  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -bottom-4 -left-4 w-32 h-32 bg-purple-500/10 rounded-full blur-2xl animate-pulse"
      ...
      <div className="relative z-10">
        ...
        <div className="mb-4">
          <div
            className="text-sm text-white/50 font-medium mb-2 animate-fade-in"
            style={{ animationDelay: "0.2s" }}
          >
            {getGreeting()}! 👋
          </div>
          <h1
            className="text-4xl font-bold bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent animate-fade-in"
        ...
        >
          <p className="text-lg text-white/80 leading-relaxed">
            Asisten AI untuk informasi seputar{" "}
            <span className="text-blue-400 font-semibold">banjir</span>
          </p>
          <p className="text-sm text-white/60 leading-relaxed">
            Dapatkan informasi terkini, tips keselamatan, dan panduan menghadapi
            banjir dengan teknologi AI terdepan.
          </p>
        </div>

        {/* Feature badges */}
        <div
          className="flex flex-wrap gap-2 mt-6 animate-fade-in"
        ...
        {/* Quick actions */}
        <div
          className="mt-6 p-4 bg-white/5 rounded-xl border border-white/10 animate-fade-in"
          style={{ animationDelay: "1s" }}
        >
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button className="text-xs text-white/70 hover:text-white bg-white/10 hover:bg-white/20 px-3 py-1 rounded-lg transition-all duration-200 border border-white/20 hover:border-white/30">
              "Tips mengamankan rumah dari banjir"
            </button>
            <button className="text-xs text-white/70 hover:text-white bg-white/10 hover:bg-white/20 px-3 py-1 rounded-lg transition-all duration-200 border border-white/20 hover:border-white/30">
              "Cek status banjir di daerah saya"
            </button>
          </div>
        </div>
      </div>
